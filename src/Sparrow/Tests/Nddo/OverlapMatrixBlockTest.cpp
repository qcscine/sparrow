...
class AGTOOverlapMatrixBlock : public Test {
 public:
  GTOOverlapMatrixBlock<Utils::DerivativeOrder::One> overlapBlock;
...
TEST_F(AGTOOverlapMatrixBlock, ReturnsIdentityForOrbitalsOnSameAtom) {
  ...
  m.setOrder(Utils::DerivativeOrder::One);
  m.setDimension(gs1.nAOs(), gs1.nAOs());
  m.get<Utils::DerivativeOrder::One>().block(0, 0, 1, 1) = overlapBlock.getMatrixBlock(gs1, gs1, Eigen::Vector3d(0, 0, 0));
  Eigen::MatrixXd blockSS = m.getMatrixXd();
  m.setDimension(gp1.nAOs(), gp1.nAOs());
  m.get<Utils::DerivativeOrder::One>().block(0, 0, 3, 3) = overlapBlock.getMatrixBlock(gp1, gp1, Eigen::Vector3d(0, 0, 0));
  Eigen::MatrixXd blockPP = m.getMatrixXd();
  m.setDimension(gd1.nAOs(), gd1.nAOs());
  m.get<Utils::DerivativeOrder::One>().block(0, 0, 5, 5) = overlapBlock.getMatrixBlock(gd1, gd1, Eigen::Vector3d(0, 0, 0));
  Eigen::MatrixXd blockDD = m.getMatrixXd();
  m.setDimension(gs1.nAOs(), gp1.nAOs());
  m.get<Utils::DerivativeOrder::One>().block(0, 0, 1, 3) = overlapBlock.getMatrixBlock(gs1, gp1, Eigen::Vector3d(0, 0, 0));
  Eigen::MatrixXd blockSP = m.getMatrixXd();
  m.setDimension(gs1.nAOs(), gd1.nAOs());
  m.get<Utils::DerivativeOrder::One>().block(0, 0, 1, 5) = overlapBlock.getMatrixBlock(gs1, gd1, Eigen::Vector3d(0, 0, 0));
  Eigen::MatrixXd blockSD = m.getMatrixXd();
  m.setDimension(gp1.nAOs(), gd1.nAOs());
  m.get<Utils::DerivativeOrder::One>().block(0, 0, 3, 5) = overlapBlock.getMatrixBlock(gp1, gd1, Eigen::Vector3d(0, 0, 0));
...
TEST_F(AGTOOverlapMatrixBlock, ReturnsCorrectDerivativesForSOrbitals) {
  ...
  m.get<Utils::DerivativeOrder::One>().block(0, 0, 1, 1) = overlapBlock.getMatrixBlock(gs1, gs2, arbitraryVector);
  Eigen::MatrixXd S1 = m.getMatrixXd();
  m.get<Utils::DerivativeOrder::One>().block(0, 0, 1, 1) =
...
TEST_F(AGTOOverlapMatrixBlock, ReturnsCorrectDerivativesForPOrbitals) {
  ...
  m.get<Utils::DerivativeOrder::One>().block(0, 0, 3, 3) = overlapBlock.getMatrixBlock(gp1, gp2, arbitraryVector);
  Eigen::MatrixXd S1 = m.getMatrixXd();

  m.get<Utils::DerivativeOrder::One>().block(0, 0, 3, 3) =
...
TEST_F(AGTOOverlapMatrixBlock, ReturnsCorrectDerivativesForDOrbitals) {
  ...
  m.get<Utils::DerivativeOrder::One>().block(0, 0, 5, 5) = overlapBlock.getMatrixBlock(gd1, gd2, arbitraryVector);
  Eigen::MatrixXd S1 = m.getMatrixXd();

  m.get<Utils::DerivativeOrder::One>().block(0, 0, 5, 5) =
