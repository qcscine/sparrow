 ...
 */
#ifndef SPARROW_NDDOSTATESHANDLER_H
#define SPARROW_NDDOSTATESHANDLER_H
...
class NDDOStatesHandler : public Utils::StatesHandler {
 public:
  /**
   ...
   */
  explicit NDDOStatesHandler(NDDOMethodWrapper& methodWrapper);
  ~NDDOStatesHandler() final;
  /**
  ...
  /**
   * @brief Returns the current state of the NDDO method.
 ...
 private:
  NDDOMethodWrapper& methodWrapper_;
};

} // namespace Sparrow
} // namespace Scine

#endif // SPARROW_NDDOSTATESHANDLER_H
