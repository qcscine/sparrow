...
#ifndef SPARROW_AM1REPULSIONENERGY_H
...
class AM1RepulsionEnergy : public Utils::RepulsionCalculator {
 public:
  ...
  //! @brief Constructor.
  AM1RepulsionEnergy(const Utils::ElementTypeCollection& elements, const Utils::PositionCollection& positions,
